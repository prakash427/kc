...
const images = [
    require('../../assets/dialogue1.png'),
    require('../../assets/dialogue2.png'),
    require('../../assets/dialogue3.png'),
    require('../../assets/dialogue4.png'),
    require('../../assets/dialogue5.png'),
    require('../../assets/dialogue6.png'),
    require('../../assets/dialogue7.png'),
    require('../../assets/dialogue8.png'),
    require('../../assets/dialogue9.png'),
    require('../../assets/dialogue10.png'),
    require('../../assets/dialogue11.png'),
    require('../../assets/dialogue12.png'),
    require('../../assets/dialogue1.png'),
    require('../../assets/dialogue2.png'),
    require('../../assets/dialogue3.png'),
    require('../../assets/dialogue4.png'),
...
const ChirusdialoguesScreen = ({ updateStreaming,updateDialogue,updateMovies,updateNews, updateEvents, updateGallery }) => {
    const handleClick = () => {
...
export default ChirusdialoguesScreen;